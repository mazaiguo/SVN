...
#else
Acad::ErrorStatus ArxDbgDwgFiler::readBytes(void *buf, Adesk::UInt32 cnt)
#endif
{
    m_str = _T("");
...
#else
Adesk::Int32 ArxDbgDwgFiler::tell() const
#endif
{
    acutPrintf(_T("\nArxDbgDwgFiler::tell()"));
    return 0L;
...
#else
Acad::ErrorStatus ArxDbgDwgFiler::seek(Adesk::Int32 nPos, int nMode)
#endif
{
    acutPrintf(_T("\nArxDbgDwgFiler::seek()"));
    return Acad::eOk;
