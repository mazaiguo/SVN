...
LPCTSTR
ArxDbgUtils::renderModeToStr(AcDbAbstractViewTableRecord::RenderMode type, CString& str)
{
...
{
    ArxDbgKeywordArray kwords(ArxDbgUtils::GetAppHinstance());
