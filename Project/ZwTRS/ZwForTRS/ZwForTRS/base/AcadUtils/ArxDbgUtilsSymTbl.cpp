...
Acad::ErrorStatus ArxDbgUtils::AddtoModelSpace(AcDbEntity*pEnt, AcDbObjectId&retId, AcDbDatabase* pDb/* =NULL */)
{
	Acad::ErrorStatus es;
...
Acad::ErrorStatus ArxDbgUtils::AddtoModelSpaceAndClose(AcDbEntity*pEnt, AcDbObjectId&retId, AcDbDatabase* pDb/* =NULL */)
{
	Acad::ErrorStatus es;
	AcDbBlockTable* pBlockTable;	//块表指针
	if(pDb==NULL)
