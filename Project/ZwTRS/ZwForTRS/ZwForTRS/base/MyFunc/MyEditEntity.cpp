...
bool MyEditEntity::OpenObjAppendStrToXdata(AcDbObjectId objId, CString strAppName, CString strData)
{
	...
	ArxDbgAppXdata connor(strAppName, pObj->database());
...
AcDbObjectId MyEditEntity::CreateDimstyle(CString strDimName, double dHeight, double dDimlfac /* = 1.0 */, bool bDimTih, bool bDimToh)
{
