//-----------------------------------------------------------------------------
//----- CObjectAppendToDb.h : Declaration of the CObjectAppendToDb
//-----------------------------------------------------------------------------
#pragma once
...
class /*DLLIMPEXP*/ CObjectAppendToDb : public AcDbDatabaseReactor {

public:
	ACRX_DECLARE_MEMBERS(CObjectAppendToDb) ;
...
public:
	CObjectAppendToDb (AcDbDatabase *pDb =NULL) ;
	virtual ~CObjectAppendToDb () ;
...
#ifdef ZWFORTRS_MODULE
ACDB_REGISTER_OBJECT_ENTRY_AUTO(CObjectAppendToDb)
#endif
