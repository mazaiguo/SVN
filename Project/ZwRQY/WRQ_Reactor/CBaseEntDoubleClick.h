//-----------------------------------------------------------------------------
//----- CBaseEntDoubleClick.h : Declaration of the CBaseEntDoubleClick
//-----------------------------------------------------------------------------
#pragma once
...
class /*DLLIMPEXP*/ CBaseEntDoubleClick : public AcEditorReactor {
...
public:
	CBaseEntDoubleClick (const bool autoInitAndRelease =true) ;
	virtual ~CBaseEntDoubleClick () ;
