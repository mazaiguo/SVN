...
bool CDoEduDWG::RemoveEduPlotStamp_Force(const AcDbDatabase* pDb)
...
bool CDoEduDWG::RemoveEduPlotStamp_13(const AcDbDatabase* pDb)
...
bool CDoEduDWG::RemoveEduPlotStamp_10(const AcDbDatabase* pDb)
...
bool CDoEduDWG::RemoveEduPlotStamp_06(const AcDbDatabase* pDb)
...
bool CDoEduDWG::RemoveEduPlotStamp_05(const AcDbDatabase* pDb)
...
bool CDoEduDWG::RemoveEduPlotStamp_04(const AcDbDatabase* pDb)
...
bool CDoEduDWG::Split(CString& src, CString token, CStringArray& resultArray,bool ingoreEmptyString)
...
BOOL CDoEduDWG::IsValidLong(const CString value,long &lValue)
...
int CDoEduDWG::_getHostAppMinorVersion()
...
int CDoEduDWG::getHostAppMinorVersion()
...
void CDoEduDWG::RemoveEduPlotStamp(const AcDbDatabase* pDb)
...
bool CDoEduDWG::RemoveZWEduPlotStamp(const AcDbDatabase* pDb)
