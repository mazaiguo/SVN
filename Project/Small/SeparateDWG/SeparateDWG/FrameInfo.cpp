...
AcGePoint3d FrameInfo::centerPoint(void)
{
...
{
	//Utility util;
	//util.CreateLine(m_minPoint, AcGePoint3d(m_maxPoint.x, m_minPoint.y));
	//util.CreateLine(AcGePoint3d(m_maxPoint.x, m_minPoint.y), m_maxPoint);
	//util.CreateLine(m_maxPoint, AcGePoint3d(m_minPoint.x, m_maxPoint.y));
	//util.CreateLine(AcGePoint3d(m_minPoint.x, m_maxPoint.y), m_minPoint);
	//// X
	//util.CreateLine(m_minPoint, m_maxPoint);
	//util.CreateLine(AcGePoint3d(m_maxPoint.x, m_minPoint.y), AcGePoint3d(m_minPoint.x, m_maxPoint.y));
}
...
AcGePoint3d FrameInfo::GetminPoint()
{
	return m_minPoint;
}

AcGePoint3d FrameInfo::GetmaxPoint()
{
	return m_maxPoint;
}
